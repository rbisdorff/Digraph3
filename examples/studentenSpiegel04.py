...
objectives = OrderedDict([
    ('HLM', {'name':'Humanities, Law, Economics & Management',
             'criteria': ['germ','pol','psy','soc','law','eco','mgt'],
             'weight':7.0}),
    ('STM', {'name':'Sciences, Technology & Medecine',
             'criteria': ['phys','chem','math','info','elec','mec','bio','med'],
             'weight':8.0}),
])
...
'thresholds': {'ind': (Decimal('0.0'), Decimal('0.1')), 'pref': (Decimal('0.5'), Decimal('0.0'))},
}),
('pol', {
'shortName': 'pol',
'name': 'Politology',
...
'shortName': 'phys',
'name': 'Physics',
'comment': 'Sciences, Technology & Medecine',
'weight': Decimal('1.0'),
'scale': (45.0, 65.0),
'preferenceDirection': 'max',
'thresholds': {'ind': (Decimal('0.0'), Decimal('0.1')), 'pref': (Decimal('0.5'), Decimal('0.0'))},
