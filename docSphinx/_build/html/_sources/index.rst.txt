...
The *Digraph3 documentation*, available on the `Read The Docs <https://readthedocs.org/>`_ site: |location_link1|, describes the Python3 resources for implementing fair and accountable decision algorithms via **bipolar-valued outranking** digraphs [:raw-html:`<a class="reference internal" href="#Bisdorff-2022" id="id1"><span>1</span></a>`]. These computing resources are useful in the field of **Algorithmic Decision**  and more specifically in the field of **Multiple-Criteria Decision Support** [:raw-html:`<a class="reference internal" href="#Bisdorff-2015" id="id2"><span>2</span></a>`]. They provide practical tools for a Master Course on |location_link4| taught at the University of Luxembourg.
