# -*- coding: utf-8 -*-
#
# Digraph3 documentation build configuration file, created by
...
inheritance_graph_attrs = dict(rankdir="LR", size='"15.0, 40.0"')
...
project = 'Digraph3'
copyright = '2012-2023, Raymond Bisdorff'
...
html_short_title = 'Digraph3 Documentation'

# The name of an image file (relative to this directory) to place at the top
# of the sidebar.
html_logo = 'htmlLogo.png'
...
# The style of line numbers for code-blocks RB
# the default 'inline' (4.0.1) does not work for the :emphasize-lines: option
...
'maketitle': r'''
    ...
    ''',
# Uncomment for suppressing the latex table of contents
# By default '\sphinxtableofcontents'
'tableofcontents': r'''
...
man_pages = [
    ('index', 'Digraph3', 'Digraph3 Documentation',
     ['Raymond Bisdorff'], 1)
]
...
texinfo_documents = [
  ('index', 'Digraph3', 'Digraph3 Documentation',
   'Raymond Bisdorff', 'Digraph3', 'One line description of project.',
   'Miscellaneous'),
]
