...
# Current revision $Revision: 1.694 $
...
class Digraph(object):
    ...
    def iterateRankingByChoosing(self,CoDual=False,Comments=True,Debug=False):
        ...
        if Comments:
            ...
            print('(Kendall distance from the indeterminate graph)')
            i = 0
            ...
            for y in actionsList:
                if hasIntegerValuation:
                    if hasLPDDenotation:
                        ...
                        print('$%+d$ &' % (self.relation[x[1]][y[1]]), end=' ')
                    else:
                        print('%+d ' % (self.relation[x[1]][y[1]]), end=' ')
                else:
                    if hasLPDDenotation:
                        ...
                        print('$%+2.2f$ & ' % (self.relation[x[1]][y[1]]), end=' ')       
                    else:
                        print('%+2.2f ' % (self.relation[x[1]][y[1]]), end=' ')
