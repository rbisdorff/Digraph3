...
def testVotingProfiles():
    ...
    g = MajorityMarginsDigraph(vt,hasIntegerValuation=False)
    g.showRelationTable()
    g.showStatistics()
    ...
    print(vt1.voters)
    print(vt1.ballot)
    g1 = MajorityMarginsDigraph(vt1,hasIntegerValuation=True)
    g1.showRelationTable()
    g1.showStatistics()
    g2 = MajorityMarginsDigraph('tempVprofile',majorityMargins=True)
    g2.showStatistics()        
...
def testApprovalVotingProfiles():
    ...
    vt.showResults()
    vt.showAll()
    g = MajorityMarginsDigraph(vt,approvalVoting=True,hasIntegerValuation=True)
    g.showRelationTable()
    g.showStatistics()
