#######################
# R. Bisdorff
# pytest functions for the sparseOutrankingDigraphs module
...
def testexportSortingGraphViz():
    ...
    print(bg1)
    bg1.showComponents()
    bg1.exportSortingGraphViz(actionsSubset=bg1.boostedRanking[:100],bgcolor='lightblue')     
...
##                                      seed=100)
    ...
    pr.exportGraphViz(fileName='fusion-cpr-pr',graphType="pdf",bgcolor=None)
