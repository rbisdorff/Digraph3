...
class SmartBachetRanking(PolarisedBachetRanking):
    ...
    def __init__(self,g,CoDual=False,actionsList=None,
        ...
        bestCorr = 0.0
        bestList = al
        bestBa = PolarisedBachetRanking(g)
        for i in rdIndex:
            tr = triples[i]
            if Debug:
                print(tr)
...
##        print('wcop2',wcop2.copelandRanking,corrwcop2)
        ...
        res.write('%d,%.4f,%.4f,%.4f,%.4f\n' % (seed,corrba1['correlation'],
                                        ...
                                        corrnf['correlation']) )
    res.close()
    ba4 = SmartBachetRanking(g,Debug=True,randomized=100)
    print(ba4)
