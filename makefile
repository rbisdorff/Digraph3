...
bachetNumbersTests:
		cp bachetNumbers.py ${TESTDIR}/
		(cd ${TESTDIR}; ${PYTEST} -v ../pytestsBachetNumbers.py)
verboseBachetNumbersTests:
		cp bachetNumbers.py ${TESTDIR}/
		(cd ${TESTDIR}; ${PYTEST} -vs ../pytestsBachetNumbers.py)
bipolarValuedSetsTests:
		cp bipolarValuedSets.py ${TESTDIR}/
		(cd ${TESTDIR}; ${PYTEST} -v ../pytestsBipolarValuedSets.py)
verboseBipolarValuedSetsTests:
		cp bipolarValuedSets.py ${TESTDIR}/
		(cd ${TESTDIR}; ${PYTEST} -vs ../pytestsBipolarValuedSets.py)
mpTests:
