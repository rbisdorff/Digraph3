...
modules = arithmetics.py digraphs.py digraphsTools.py graphs.py linearOrders.py outrankingDigraphs.py pairings.py performanceQuantiles.py perfTabs.py randomDigraphs.py randomNumbers.py randomPerfTabs.py ratingDigraphs.py sortingDigraphs.py sparseOutrankingDigraphs.py transitiveDigraphs.py dynamicProgramming.py votingProfiles.py xmcda.py
